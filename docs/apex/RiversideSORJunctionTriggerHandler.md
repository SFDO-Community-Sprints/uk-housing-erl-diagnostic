...
# RiversideSORJunctionTriggerHandler Class
...
```mermaid
graph TD
  RiversideSORJunctionTriggerHandler["RiversideSORJunctionTriggerHandler"]:::mainApexClass
  click RiversideSORJunctionTriggerHandler "/objects/RiversideSORJunctionTriggerHandler/"
  RiversideSORJunctionHelper["RiversideSORJunctionHelper"]:::apexClass
  click RiversideSORJunctionHelper "/apex/RiversideSORJunctionHelper/"
...
```java
public with sharing class RiversideSORJunctionTriggerHandler extends TriggerHandler {
    public override void afterInsert() {
        RiversideSORJunctionHelper.updateExternalIdentifier((Set<Id>) Trigger.newMap.keySet());
    }
}
```
