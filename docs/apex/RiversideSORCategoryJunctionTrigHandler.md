...
# RiversideSORCategoryJunctionTrigHandler Class
...
```mermaid
graph TD
  RiversideSORCategoryJunctionTrigHandler["RiversideSORCategoryJunctionTrigHandler"]:::mainApexClass
  click RiversideSORCategoryJunctionTrigHandler "/objects/RiversideSORCategoryJunctionTrigHandler/"
  RiversideSORCategoryJunctionHelper["RiversideSORCategoryJunctionHelper"]:::apexClass
  click RiversideSORCategoryJunctionHelper "/apex/RiversideSORCategoryJunctionHelper/"
  TriggerHandler["TriggerHandler"]:::apexClass
  click TriggerHandler "/apex/TriggerHandler/"
  RiversideSORCategoryJunctionTrigger["RiversideSORCategoryJunctionTrigger"]:::apexClass
  click RiversideSORCategoryJunctionTrigger "/apex/RiversideSORCategoryJunctionTrigger/"

  RiversideSORCategoryJunctionTrigHandler --> RiversideSORCategoryJunctionHelper
...
```java
public with sharing class RiversideSORCategoryJunctionTrigHandler extends TriggerHandler {
    public override void afterInsert() {
        RiversideSORCategoryJunctionHelper.updateExternalIdentifier((Set<Id>) Trigger.newMap.keySet());
    }
}
```
